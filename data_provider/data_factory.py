...
from data_provider.data_loader import Dataset_ReTATSF_weather, Dataset_ReTATSF_Economy, Dataset_ReTATSF_Energy
import torch
...
def ReTATSF_Economy_data_provider(args, flag, target_ids, device):
    TS_data_path = args.TS_data_path
    QT_data_path = args.QT_data_path
    QT_emb_path = args.QT_emb_path
    NewsDatabase_path = args.NewsDatabase_path
...
def ReTATSF_Energy_data_provider(args, flag, target_ids, device):
    TS_data_path = args.TS_data_path
    QT_data_path = args.QT_data_path
    QT_emb_path = args.QT_emb_path
