import argparse
import torch
from exp.exp_ReTATSF_Health_US import Exp_Main
import random
import numpy as np
...
parser.add_argument('--TS_data_path', type=str, default='Time-MMD/numerical/Health_US/Health_US.parquet', help='Time series data path')
parser.add_argument('--QT_emb_path', type=str, default='Time-MMD/textual/Health_US/QueryText-embedding-paraphrase-MiniLM-L6-v2-ForecastingPoint', help='Query text embedding data path')
parser.add_argument('--Des_emb_path', type=str, default='Time-MMD/textual/Health_US/QueryText-embedding-paraphrase-MiniLM-L6-v2-Description', help='Description embedding data path')
parser.add_argument('--NewsDatabase_path', type=str, default='Time-MMD/textual/Health_US/NewsDatabase-embedding-paraphrase-MiniLM-L6-v2', help='News database path')
