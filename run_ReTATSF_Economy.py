...
parser.add_argument('--QT_data_path', type=str, default='Time-MMD/textual/Economy/QueryTextPackage.parquet', help='Query des text data path')
parser.add_argument('--QT_emb_path', type=str, default='Time-MMD/textual/Economy/QueryText-embedding-paraphrase-MiniLM-L6-v2', help='Query text embedding data path')
