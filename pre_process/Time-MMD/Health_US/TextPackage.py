import pandas as pd
df = pd.read_csv('../../../dataset/Time-MMD/textual/Health_US/Health_US_report.csv')
...
df_search = pd.read_csv('../../../dataset/Time-MMD/textual/Health_US/Health_US_search.csv')
...
df_combined.to_parquet('../../../dataset/Time-MMD/textual/Health_US/Health_US_combined.parquet')