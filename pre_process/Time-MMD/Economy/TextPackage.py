...
df_search = pd.read_csv('../../../dataset/Time-MMD/textual/Economy/Economy_search.csv')
...
df_combined.to_parquet('../../../dataset/Time-MMD/textual/Economy/Economy_combined.parquet')