...
save_dir = f'../../../dataset/Time-MMD/textual/Economy/NewsDatabase-embedding-{BERT_model}'
...
df = pd.read_parquet('../../../dataset/Time-MMD/textual/Economy/Economy_combined.parquet')
