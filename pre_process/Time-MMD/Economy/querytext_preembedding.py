...
if ForecastingPoint:
    save_dir = f'../../../dataset/Time-MMD/textual/Economy/QueryText-embedding-{BERT_model}-ForecastingPoint/{target_id}'
    ...
    save_dir = f'../../../dataset/Time-MMD/textual/Economy/QueryText-embedding-{BERT_model}-Description/{target_id}'
    os.makedirs(save_dir, exist_ok=True)
    qt = (
