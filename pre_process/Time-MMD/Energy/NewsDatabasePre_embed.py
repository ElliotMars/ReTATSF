...
save_dir = f'../../../dataset/Time-MMD/textual/Energy/NewsDatabase-embedding-{BERT_model}'
...
df = pd.read_parquet('../../../dataset/Time-MMD/textual/Energy/Energy_combined.parquet')
