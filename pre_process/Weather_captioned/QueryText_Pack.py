...
physical_quantities = {
    ...
    "sh (g_kg)": ["Specific humidity, the mass of water vapor in a given mass of air, including the water vapor. It’s measured in grams of water vapor per kilogram of air."],
    "H2OC (mmol_mol)": ["Water vapor concentration, expressed in millimoles of water per mole of air. It’s another way to quantify the amount of moisture in the air."],
    "rho (g_m**3)": ["Air density, measured in grams per cubic meter. It indicates the mass of air in a given volume and varies with temperature, pressure, and moisture content."],
    "wv (m_s)": ["Wind velocity, the speed of the wind measured in meters per second."],
    "max. wv (m_s)": ["Maximum wind velocity observed in the given time period, measured in meters per second."],
    ...
    "SWDR (W_m2)": ["Shortwave Downward Radiation, the amount of solar radiation reaching the ground, measured in watts per square meter."],
    "PAR (umol_m2_s)": ["Photosynthetically Active Radiation, the amount of light available for photosynthesis, measured in micromoles of photons per square meter per second."],
    "max. PAR (umol_m2_s)": ["Maximum Photosynthetically Active Radiation observed in the given time period, indicating the peak light availability for photosynthesis."],
...
# 存储为 Parquet 文件
df.to_parquet("../../dataset/Weather_captioned/QueryTextPackage.parquet", engine="pyarrow")