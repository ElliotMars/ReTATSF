...
from data_provider.data_factory import ReTATSF_Economy_data_provider
import time
import numpy as np
import os
...
class Exp_Main(Exp_Basic):
    ...
    def _get_data(self, flag, target_ids):
        data_set, data_loader = ReTATSF_Economy_data_provider(self.args, flag, target_ids, self.device)
