...
class Exp_Main(Exp_Basic):
    ...
    def train(self, setting):
        ...
        for target_id in self.target_ids:
            ...
            train_data, train_loader = self._get_data(flag='train', target_id=target_id)
            vali_data, vali_loader = self._get_data(flag='val', target_id=target_id)
            ...
            for epoch in range(self.args.train_epochs):
                ...
                print("Target: {} Epoch: {} cost time: {}".format(target_id, epoch + 1, time.time() - epoch_time))
        ...
        for target_id in self.target_ids:
            ...
            if test:
                ...
                self.model.load_state_dict(torch.load(
                    ...
                    os.path.join(self.args.checkpoints, "0315_172613_Target_['p (mbar)'] SeqLen_60 PredLen_14 Train_1 GPU_True Kt_5 Kn6 Naggregation_3 Nperseg_30 LR_0.0001 Itr_1 bs_16/p (mbar)_best_checkpoint.pth")
                ))
            ...
            print('target_{}: mse_{}, mae_{}'.format(target_id, mse, mae))
            ...
            np.save(os.path.join(folder_path, target_id+'_pred.npy'), preds)
            np.save(os.path.join(folder_path, target_id+'_trues.npy'), trues)
            np.save(os.path.join(folder_path, target_id+'_x.npy'), inputx)